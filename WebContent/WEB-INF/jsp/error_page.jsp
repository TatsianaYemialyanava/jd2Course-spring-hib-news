...
<fmt:message bundle="${interfaceBundle}" key="exceptionPage.message1"
	var="message1" />
...
<fmt:message bundle="${interfaceBundle}"
	key="exceptionPage.backToMainPage" var="ex_backToMainPage" />
...
<body>
	...
	<div align="center">
		...
		<a href="Controller?command=gotoindexpage"> <c:out
				value="${ex_backToMainPage}" />
		</a>
	</div>
